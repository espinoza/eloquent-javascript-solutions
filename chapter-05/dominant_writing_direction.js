// -- Copied from Eloquent JavaScript --
...
countCharsByDirection = items => {
  return countBy(items, char => {
...
dominantDirection = text => {
  return countCharsByDirection(text).reduce(
    (dir1, dir2) => dir1.count > dir2.count ? dir1.name : dir2.name,
  );
}



// -- Data set provided by Eloquent JavaScript --
